...
function getUserInfoStream(username, accessToken, clientId) {
  ...
  function showUserInfo(userInfo) {
    ...
    const userInfoHTML = `
      <div id="userInfo" style="display: flex; justify-content: space-between; align-items: flex-start;">
        <a href="https://www.twitch.tv/${login}" target="_blank"> <img src="${profile_image_url}" alt="Foto de perfil"/> <a/>
        <p><img class="icon" src="https://cdn-icons-png.flaticon.com/512/1946/1946429.png" alt="Usuario"><strong>:</strong><strong> ${login}</strong> ${
      stream_info ? '<img src="https://cdn-icons-png.flaticon.com/512/5822/5822037.png" alt="En vivo" />' : ''
    }</p>
        <p><img class="icon" src="https://cdn-icons-png.flaticon.com/512/3528/3528062.png" alt="Descripcion"/><strong>:</strong> ${description}</p>
        ${
          stream_info
            ? `
          
          <p><strong>Juego:</strong> <strong>${stream_info.game_name}</strong></p>
         
          <p><img class="icon" src="https://cdn-icons-png.flaticon.com/512/4449/4449637.png" alt="Usuario"><strong>:</strong> <strong>${stream_info.viewer_count}</strong></p>
